...
| Mobile app implementation (iOS/Android/Flutter/React Native) | Mobile platform work — scaffolding, builds and code signing, device/emulator testing, store submission, and mobile lifecycle — is outside this skill; this skill owns web frontends |
